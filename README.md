...
<section>
   <p>
      <strong>Published in 1994</strong> in the book <strong>Design Patterns:
      Elements of Reusable Object-Oriented Software</strong>, it is a set
      of reusable solutions to recurring problems in <strong>software
      development</strong>, applicable across different programming
      languages. These are high-level concepts used to address
      <strong>specific situations</strong>.
   </p>
</section>
